...
id = 0
# names related to ids: The names associated to the ids
names = ['None','Apeksha','Malani','Anupa','Mekhala','Barun','Nikhil','Aditya','Tayde','Sawant']  # add a name into this list

# --------------------

# load our serialized face detector model from disk
prototxtPath = r"C:\xampp\htdocs\Face-mask-catcher\face_detector\deploy.prototxt"
weightsPath = r"C:\xampp\htdocs\Face-mask-catcher\face_detector\res10_300x300_ssd_iter_140000.caffemodel"
